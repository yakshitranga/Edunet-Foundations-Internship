...
st.markdown("""
    <style>
        ...
        .stApp {
            background: linear-gradient(to right, ##183c7d, #60656b);
        }
    </style>
...
st.markdown("""
    <div style='text-align: center; font-size: 36px; font-weight: bold; color: #FFFFFF; margin-top: 20px;'>
        🔮 EV Adoption Forecaster for a County in Washington State 🏎️
    </div>
""", unsafe_allow_html=True)
...
# Image
st.image("ev-car-factory.jpeg", use_container_width=True)
...
st.markdown(" ")
st.markdown("Yakshit Ranga")
st.markdown("yakshit.ranga@gmail.com | www.github.com/yakshitranga | www.linkedin.com/in/yakshit-ranga")